...
- **Interface**: Visual regression + axe checks for `IC-13` verifying timeline accessibility, counter animation fallback, CTA strip behaviour, and community carousel controls.
