...
## Key references
- **UI/UX spec**: `../ui-ux-aesthetics.md` (sections 2.5–2.9 for imagery, KPI/impact tiles, glass CTA strips, and bilingual CTA states).
...
| Design blueprints & journeys | `30-design/` | `content/design/` | `sha256:7445b3d19a17611ee10c8e3487e0be963d014e0236d7ab67ab1b53509c662f33` | Hero copy plus LLM/SEO plan for storytelling modules (use `../ui-ux-aesthetics.md` for visuals).
...
- **Q:** What narrative beats are mandatory above the fold?
  - **A/Decision:** Feature the mission headline, founders' origin story, and sustainability commitments before scroll depth 1.0 using the copy direction in `content/design/blueprints/hero-copy.md` plus imagery from `assets/images/brand/` (`Finspeed Product Owner — 2025-11-04`).
