...
- **Interface**: Snapshot and accessibility tests for `IC-11` covering hero, gallery, spec tabs, CTA disabled state, and dealer outage banner. Verify Next.js route builds with no hydration mismatches.
