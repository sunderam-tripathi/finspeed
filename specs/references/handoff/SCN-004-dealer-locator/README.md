...
## Key references
- **UI/UX spec**: `../ui-ux-aesthetics.md` (sections 2.4–2.9 for map marker styles, glass overlays, CTA/focus states, and bilingual form validation).
...
| Design blueprints & journeys | `30-design/` | `content/design/` | `sha256:7445b3d19a17611ee10c8e3487e0be963d014e0236d7ab67ab1b53509c662f33` | Locator flow notes and hero copy (pair with `../ui-ux-aesthetics.md` for visuals). |
...
## Client Q&A
- **Q:** What defaults should power the search behaviour?
