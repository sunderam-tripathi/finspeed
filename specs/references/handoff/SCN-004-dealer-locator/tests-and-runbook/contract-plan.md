...
- **UI**: Component contract tests for `IC-12` verifying postal validation, filter chips, synchronized map focus, and outage banner state. Accessibility assertions (keyboard nav, aria labels) captured via Playwright axe.
