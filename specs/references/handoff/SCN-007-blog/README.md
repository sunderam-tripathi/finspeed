...
## Key references
- **UI/UX spec**: `../ui-ux-aesthetics.md` (sections 2.5–2.9 for blog imagery, glass hero treatments, CTA/tab states, and bilingual form behaviors).
...
| Design blueprints & journeys | `30-design/` | `content/design/` | `sha256:7445b3d19a17611ee10c8e3487e0be963d014e0236d7ab67ab1b53509c662f33` | Content structure guidance, LLM search strategy, and hero copy (use `../ui-ux-aesthetics.md` for visuals).
