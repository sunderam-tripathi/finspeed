...
## Key references
- **UI/UX spec**: `../ui-ux-aesthetics.md` (sections 2.4–2.9 cover card styles, filter/tab states, glass surfaces, and KPI badges required for the catalog grid).
...
| Design blueprints & journeys | `30-design/` | `content/design/` | `sha256:7445b3d19a17611ee10c8e3487e0be963d014e0236d7ab67ab1b53509c662f33` | Hero copy, SEO prompts, and flow notes (pair with `../ui-ux-aesthetics.md` for visuals). |
